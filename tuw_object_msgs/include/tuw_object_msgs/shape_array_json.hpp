...
#include <tuw_object_msgs/object_json.hpp>
#include <tuw_object_msgs/object_map.hpp>

namespace tuw_json
{
inline Json::Value toJson(const tuw_object_msgs::msg::ObjectMap & src)
{
  Json::Value json;
...
inline tuw_object_msgs::msg::ObjectMap & fromJson(
  const Json::Value & json, tuw_object_msgs::msg::ObjectMap & des)
{
